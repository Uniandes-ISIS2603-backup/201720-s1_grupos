(function (ng) {
     ...
     */
    mod.controller("patrocinioEventosDeleteCtrl", ['$scope', '$state', '$http','eventosContext','patrociniosContext', 
        function ($scope, $state, $http,eventosContext,patrociniosContext) {
             /**
            ...
            {
                var fullContext = "Stark/" + eventosContext + "/"+$state.params.eventoId +"/"+ patrociniosContext + "/" + $state.params.patrocinioId;
